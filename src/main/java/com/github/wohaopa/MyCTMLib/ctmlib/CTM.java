...
import static com.github.wohaopa.MyCTMLib.ctmlib.Dir.BOTTOM;
import static com.github.wohaopa.MyCTMLib.ctmlib.Dir.BOTTOM_LEFT;
import static com.github.wohaopa.MyCTMLib.ctmlib.Dir.BOTTOM_RIGHT;
import static com.github.wohaopa.MyCTMLib.ctmlib.Dir.LEFT;
import static com.github.wohaopa.MyCTMLib.ctmlib.Dir.RIGHT;
import static com.github.wohaopa.MyCTMLib.ctmlib.Dir.TOP;
import static com.github.wohaopa.MyCTMLib.ctmlib.Dir.TOP_LEFT;
import static com.github.wohaopa.MyCTMLib.ctmlib.Dir.TOP_RIGHT;
...
public class CTM {
    ...
    public boolean isConnected(IBlockAccess world, int x, int y, int z, ForgeDirection dir, Block block, int meta) {
        ...
        if (connectionBlocked(world, x, y, z, dir.ordinal())) {
            return false;
        }
