...
public class TextureSubmap implements IIcon, ISubmap {
    ...
    private static final List<TextureSubmap> submaps = Lists.newArrayList();
    private static final TextureSubmap dummy = new TextureSubmap(null, 0, 0);
    static {
    ...
    private static class TextureVirtual implements IIcon {
